...
import { IconPhone, IconLock, IconCopy } from '@douyinfe/semi-icons';
...
const PasswordResetConfirm = () => {
  ...
  const { phone, token } = inputs;
  const isValidResetLink = phone && token;
            ...
            <Card className="shadow-xl border-0 !rounded-2xl overflow-hidden">
              ...
              <div className="px-2 py-8">
                ...
                <Form
                  ...
                  initValues={{ phone: phone || '', newPassword: newPassword || '' }}
                  className="space-y-4"
                >
                  <Form.Input
                    field="phone"
